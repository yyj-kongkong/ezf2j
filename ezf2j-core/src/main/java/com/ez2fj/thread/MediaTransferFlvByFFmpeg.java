...
public class MediaTransferFlvByFFmpeg extends MediaTransfer {
	...
	public MediaTransferFlvByFFmpeg(Camera camera) {
		command.add(System.getProperty(EZF2JConfig.ffmpegPathKey));
		this.camera = camera;
		buildCommand();
	}
	...
	private void buildCommand() {
		...
		this.addArgument("-i").addArgument(camera.getUrl())
...
//			executable = "ffmpeg";
			executable = System.getProperty(EZF2JConfig.ffmpegPathKey);
		}
